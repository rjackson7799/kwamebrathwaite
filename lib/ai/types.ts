...
/**
 * SEO & Accessibility content generated by AI
 */
export interface GeneratedSEOContent {
  ...
  /** Accessibility description for screen readers (max 125 chars) */
  alt_text: string
  /** Page title for browser tab (max 70 chars) */
  meta_title: string
  /** Search engine snippet (150-160 chars) */
  meta_description: string
}

/**
 * Translated SEO content for a specific language
 */
export interface TranslatedSEOContent {
  seo_title: string
  alt_text: string
  meta_title: string
  meta_description: string
...
/**
 * Complete SEO generation result with translations and usage metrics
 */
export interface SEOGenerationResult extends GeneratedSEOContent {
  translations: {
    fr: TranslatedSEOContent
    ja: TranslatedSEOContent
  }
  tokens_used: number
  cost_usd: number
}
...
/**
 * Options for the SEO generation function
 */
export interface SEOGenerationOptions {
  /** Public URL to the artwork image */
  image_url: string
  /** Artwork metadata for context */
  metadata: ArtworkMetadata & { description?: string | null }
  /** Whether to include FR/JA translations (default: true) */
  include_translations?: boolean
}
