    ...
    <main className="bg-[#0e0e0e] text-[#E6E2D6] min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-6 sm:px-10 py-16 sm:py-24">
        <article className="max-w-2xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl text-[#F5EFE0] mb-3 leading-tight">
            {t('heading')}
          </h1>

          <p className="text-sm text-[#8a8a8a] mb-12 font-serif italic">
            {t('subheading')}
          </p>
          ...
          <p className="text-[10px] uppercase tracking-[0.18em] text-[#8a6f2b] mb-6 font-serif">
            {t('editionInfo')}
          </p>
