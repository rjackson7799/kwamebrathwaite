            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-transparent border border-white/40 text-white placeholder:text-white/50 px-4 py-3 text-body-sm focus:outline-none focus:border-white transition-colors duration-fast"
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
            ...
            <nav className="space-y-2">
              {navLinks.map(({ href, key }) => (
                <Link
                  ...
                  className="block text-body-sm text-white/80 hover:text-white transition-colors duration-fast"
                >
                  {tNav(key)}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                ...
                className="text-white/80 hover:text-white transition-colors duration-fast"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
