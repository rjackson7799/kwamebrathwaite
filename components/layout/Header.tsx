    ...
    <header className="sticky top-0 z-sticky bg-white dark:bg-[#121212] border-b border-gray-light dark:border-[#333333]">
      <div className="flex items-center justify-between h-20 px-6 md:px-12 max-w-container mx-auto">
        ...
        <Link
          ...
          className="font-heading text-[1rem] md:text-[1.85rem] font-light uppercase tracking-[0.13em] whitespace-nowrap text-black dark:text-[#F0F0F0] hover:text-gray-warm dark:hover:text-[#A0A0A0] transition-colors duration-fast"
        >
          Kwame Brathwaite
        </Link>
