...
interface GeneratedPressSEO {
  meta_title: string
  meta_description: string
}

interface PressSEOGenerateButtonProps {
  pressId: string
  onGenerated: (seo: GeneratedPressSEO) => void
}

export function PressSEOGenerateButton({ pressId, onGenerated }: PressSEOGenerateButtonProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch(`/api/admin/press/${pressId}/generate-seo`, {
        method: 'POST',
